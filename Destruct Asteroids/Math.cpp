...
const Vector3D Vector3D::Infinity(Math::Infinity, Math::Infinity, Math::Infinity);
const Vector3D Vector3D::NegInfinity(Math::NegInfinity, Math::NegInfinity, Math::NegInfinity);
...
Vector2D Vector2D::Transform(const Vector2D& vec, const Matrix3& mat, float w /*= 1.0f*/)
{
	Vector2D retVal;
...
Vector3D Vector3D::Transform(const Vector3D& vec, const Matrix4& mat, float w /*= 1.0f*/)
{
	Vector3D retVal;
...
Vector3D Vector3D::TransformWithPerspDiv(const Vector3D& vec, const Matrix4& mat, float w /*= 1.0f*/)
{
	Vector3D retVal;
	retVal.x = vec.x * mat.mat[0][0] + vec.y * mat.mat[1][0] +
		vec.z * mat.mat[2][0] + w * mat.mat[3][0];
