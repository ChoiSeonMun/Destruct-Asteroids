...
public:
	...
	static Vector3D Transform(const Vector3D& vec, const class Matrix4& mat, float w = 1.0f);
	// This will transform the vector and renormalize the w component
	static Vector3D TransformWithPerspDiv(const Vector3D& vec, const class Matrix4& mat, float w = 1.0f);
...
public:
	...
	static Matrix3 CreateScale(const Vector2D& scaleVector)
	{
...
namespace Color
{
	static const Vector3D Black(0.0f, 0.0f, 0.0f);
	static const Vector3D White(1.0f, 1.0f, 1.0f);
	static const Vector3D Red(1.0f, 0.0f, 0.0f);
	static const Vector3D Green(0.0f, 1.0f, 0.0f);
	static const Vector3D Blue(0.0f, 0.0f, 1.0f);
	static const Vector3D Yellow(1.0f, 1.0f, 0.0f);
	static const Vector3D LightYellow(1.0f, 1.0f, 0.88f);
	static const Vector3D LightBlue(0.68f, 0.85f, 0.9f);
	static const Vector3D LightPink(1.0f, 0.71f, 0.76f);
	static const Vector3D LightGreen(0.56f, 0.93f, 0.56f);
}
